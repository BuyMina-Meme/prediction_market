...
async function start() {
  ...
  try {
    ...
    console.warn('  Init monitor not started:', (e as any)?.message || e);
  }
  ...
  try {
    ...
    console.warn('  Status monitor not started:', (e as any)?.message || e);
  }
  ...
  try {
    ...
    console.warn('  Pool sync not started:', (e as any)?.message || e);
  }
