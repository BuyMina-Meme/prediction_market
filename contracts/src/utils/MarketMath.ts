...
import { Field, UInt64, Provable, Bool } from 'o1js';
import {
  FEE_BASIS_POINTS,
...
export class MarketMath {
   ...
   */
  static calculateProportionalPayout(
    userAmount: UInt64,
    totalWinningPool: UInt64,
    totalPool: UInt64
  ): UInt64 {
   ...
   */
  static distributeFees(
    totalFees: UInt64
  ): { creator: UInt64; burn: UInt64; platform: UInt64 } {
 ...
 */
export function safeAdd(a: UInt64, b: UInt64): UInt64 {
 ...
 */
export function safeSub(a: UInt64, b: UInt64): UInt64 {
